...
def run(
    ...
    device="",  # device type (e.g., 0 or 0,1,2,3 for CUDA,  'musa' for MUSA devices (e.g., 'musa:0', 'musa:0,1,2,3'), or 'cpu')
    ...
    Args:
        ...
        device (str): device type (e.g., 0 or 0,1,2,3 for CUDA,  'musa' for MUSA devices (e.g., 'musa:0', 'musa:0,1,2,3'), or 'cpu').
...
def test(
    ...
    Args:
        ...
        device (str): Device for running tests, can be 'cpu', specific CUDA devices ('0', '0,1,2,3', etc.), or MUSA devices (e.g., 'musa:0', 'musa:0,1,2,3').
...
def parse_opt():
    ...
    Args:
        ...
        device (str): CUDA device, e.g., '0' or '0,1,2,3' or MUSA devices (e.g., 'musa:0', 'musa:0,1,2,3') or 'cpu'. Defaults to an empty string (auto-select).
